...
User function MBADA3G(_numOs)
	//M->AB9_CODTEC := POSICIONE("AA1",4,XFILIAL("AB9") + RETCODUSR(), "AA1_CODTEC" )  
	//AB9->AB9_CODTEC := POSICIONE("AA1",4,XFILIAL("AB9") + RETCODUSR(), "AA1_CODTEC" )  
	FWExecView('Inclusao por FWExecView','AB9_MVC', MODEL_OPERATION_INSERT, , { || .T. }, , , )
Return
