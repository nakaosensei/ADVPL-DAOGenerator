...
/*
LIGFIN08 - ALTERADO SQL PARA UNION EM VEZ DE OR
REFATORADO   - JOHNNY
DATA     - 17/07/17
*/
...
_CQUERY += " WHERE 
_CQUERY += " E5.E5_NUMERO = E1.E1_NUM "                                           
...
_CQUERY += " AND (E1.E1_UFILNF1=F2.F2_FILIAL AND E1.E1_USERNF1=F2.F2_SERIE AND E1.E1_UNUMNF1=F2.F2_DOC) "
...
_CQUERY += " AND E5.E5_DTDISPO >= '"+DTOS(MV_PAR03)+"'                                  
_CQUERY += " AND E5.E5_DTDISPO <= '"+DTOS(MV_PAR04)+"'               
_CQUERY += " AND (E1.E1_UFILNF2=F2.F2_FILIAL AND E1.E1_USERNF2=F2.F2_SERIE AND E1.E1_UNUMNF2=F2.F2_DOC) "
...
_CQUERY += " AND E5.E5_DTDISPO >= '"+DTOS(MV_PAR03)+"'                                  
_CQUERY += " AND E5.E5_DTDISPO <= '"+DTOS(MV_PAR04)+"'               
_CQUERY += " AND (E1.E1_UFILNF3=F2.F2_FILIAL AND E1.E1_USERNF3=F2.F2_SERIE AND E1.E1_UNUMNF3=F2.F2_DOC) "
...
_CQUERY += " AND E5.E5_DTDISPO >= '"+DTOS(MV_PAR03)+"'                                  
_CQUERY += " AND E5.E5_DTDISPO <= '"+DTOS(MV_PAR04)+"'               
_CQUERY += " AND (E1.E1_UFILNF4=F2.F2_FILIAL AND E1.E1_USERNF4=F2.F2_SERIE AND E1.E1_UNUMNF4=F2.F2_DOC) "
...
_CQUERY += " AND E5.E5_DTDISPO >= '"+DTOS(MV_PAR03)+"'                                  
_CQUERY += " AND E5.E5_DTDISPO <= '"+DTOS(MV_PAR04)+"'               
_CQUERY += " AND (E1.E1_UFILNF5=F2.F2_FILIAL AND E1.E1_USERNF5=F2.F2_SERIE AND E1.E1_UNUMNF5=F2.F2_DOC) "
