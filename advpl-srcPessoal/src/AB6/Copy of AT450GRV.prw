...
User Function AT450GRV()
	...
	_finalEmailMsg := '<font color="red">This is some text!</font> <p>Olá '+nome+', a OS de nro '+os+' aberta por você teve seu atendimento concluido, o atendente da sua ordem é o '+atdt+'.'+ Chr(13) + Chr(10) +u_barraN('Abaixo, estão listados os laudos de solução para os itens da OS em questao.:</p>')
