...
WSMETHOD LIGWS3GR WSRECEIVE NUMOS,CODCLI,LOJA,ATENDENTE,DTCHEGADA,HRCHEGADA,DTSAIDA,HRSAIDA,DTINICIAL,HRINICIAL,DTFINAL,HRFINAL,OCORR,LAUDO,ACUMUL,STATUS,TRASLA,HRSFATS,SEQ,PORTA,CAIXA,_DATA100 WSSEND COK WSSERVICE LIGWS003
	...
	BEGIN TRANSACTION			
		if u_DAB9Exists(xFilial("AB9"),NUMOS,ATENDENTE,SEQ)			
			CONOUT("ALTER")
			SEQUENCIA := SEQ
			u_DAB9Alter(xFilial("AB9"),NUMOS,SEQUENCIA,ATENDENTE,DTCHEGADA,DTSAIDA,HRCHEGADA,HRSAIDA,DTINICIAL,DTFINAL,HRINICIAL,HRFINAL,OCORR,LAUDO,u_LIGVAL(ACUMUL),STATUS,CODCLI,LOJA,TRASLA,HRSFATS)			
		else
			CONOUT("CADASTRO")
			SEQUENCIA := SEQ
			u_DAB9Cad(xFilial("AB9"),NUMOS,SEQUENCIA,ATENDENTE,DTCHEGADA,DTSAIDA,HRCHEGADA,HRSAIDA,DTINICIAL,DTFINAL,HRINICIAL,HRFINAL,OCORR,LAUDO,u_LIGVAL(ACUMUL),STATUS,CODCLI,LOJA,TRASLA,HRSFATS)
			DBSELECTAREA("AB6")
			DBSETORDER(1)
