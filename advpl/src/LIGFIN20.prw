...
/*
LIGFIN20- IMPRESSÃO DE BOLETO BRADESCO REGISTRADO
AUTOR    - JOHNNY SANTOS
DATA     - 21/07/2017
CLIENTE  - LIGUE TELECOM
*/
user function LIGFIN20()
	Private _CPERG := "LIGFIN20"
	...
	IF ALLTRIM(FUNNAME())<>"FINA040"
		...
		_dadosbanco := alltrim(getmv("MV_UBCOBRA"))
	endif
...
static function LIGFIN20()
	...
	// composição campo livre bradesco
	// 20 a 23 - 04 - Agencia cedente (sem dv, completar com zeros a esquerda se necessário)
	// 24 a 25 - 02 - Carteira
	// 26 a 36 - 11 - nosso numero sem dv
	// 37 a 43 - 07 - conta do cedente (sem dv, completar com zeros a esquerda se necessário)
	// 44 a 44 - 01 - zero
	...
	oPrint:say(nRow2+0660,755,ALLTRIM(SE1->E1_ULINDIG),oFont14b)			//	Linha Digitavel do Codigo de Barras
	...
	oPrint:say(nRow2+0780,300 ,"PAGÁVEL PREFERENCIALMENTE NA REDE BRADESCO OU BRADESCO EXPRESSO",oFont10)
	...
	oPrint:say(nRow2+0880,300 ,"LIGUE TELECOMUNICAÇÕES LTDA - CPNJ 10.442.435/0001-40",oFont10) //Nome + CNPJ
	...
	oPrint:say(nRow2+0960,nCol,substr(cString,2,1)+"/"+substr(cString,3,11)+"-"+substr(cString,14,1),oFont10)
	...
	oPrint:say(nRow2+1040,555 ,_cart                        	,oFont10)
	...
	oPrint:say(nRow3+2050,300 ,"PAGÁVEL PREFERENCIALMENTE NA REDE BRADESCO OU BRADESCO EXPRESSO",oFont10)
	...
	oPrint:Code128c(nRow3+2950, 300, SE1->E1_UCODBAR, 47)
