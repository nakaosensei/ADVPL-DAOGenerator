...
//RELATORIO DE INSTALAÇÕES VS ATIVAÇÕES DE FATURAMENTO
...
Static Function RptDef(cNome)
	...
	oSection1:= TRSection():New(oReport, "Ordem de Serviço", {"AB6"}, , .F., .T.)
	TRCell():New(oSection1,"ADA_NUMCTR" 	,"ADA","CONTRATO"  		,"@!",20)
	TRCell():New(oSection1,"AB6_NUMOS"  	,"AB6","ORDEM DE SERVIÇO"	,"@!",20)
	...
	TRCell():New(oSection1,"A1_END"  		,"SA1","ENDEREÇO"	,"@!",50)
...
Static Function ReportPrint(oReport)
	...
	while !eof()					
		...
		MatGraph("Total de Instalação vs Ativação : " + Transform(_NTOTALFAT,"@E 9,999,999.99",),.F.,.T.,.F.,2,1,aDados)
//	Enddo
Return
