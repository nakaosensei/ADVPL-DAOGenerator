...
Local nCod, aFields, cFile, nInc, cPackag, acRETPAC, nFobValue
...
Begin Sequence
   ...
   HEADER_P->AVG_C06_10 := DtoC(EEC->EEC_DTINVO)
   ...
   HEADER_P->AVG_C15_60 := AllTrim(EEC->EEC_REFIMP)
   HEADER_P->AVG_C07_10 := DtoC(EE7->EE7_DTPEDI)    
