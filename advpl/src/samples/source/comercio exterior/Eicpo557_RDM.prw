...
AADD(TB_Campos,{"WKDESCR" ,"","DESCRIPTION"}) //"DESCRIPTION" TDF - 27/08/10
...
AADD(TB_Campos,{"WKPRECO" ,"","UNIT PRICE "+SW2->W2_MOEDA,E_TrocaVP(1,_PictPrUn)}) //"UNIT PRICE " TDF - 27/08/10
...
AVPRINT oPrn NAME STR0043 //"Proforma Invoice"
   ...
   AVPAGE
        ...
        If lNewProforma
           /*PARTE2:=0
           PO557VERFIM()*/
           oPrn:Say( nLinha, 320,Upper(ExtPlusE(((nProfTot+nFreteProf+nInlandProf+nPackingProf-nDiscount)* nTaxaRel),"US$")),aFontes:TIMES_NEW_ROMAN_12)
        Else
           /*PARTE2:=0
           PO557VERFIM()*/
           oPrn:Say( nLinha, 320,Upper(ExtPlusE(((SW2->W2_FOB_TOT+SW2->W2_FRETEIN+SW2->W2_INLAND+SW2->W2_PACKING-SW2->W2_DESCONT)* nTaxaRel),"US$")),aFontes:TIMES_NEW_ROMAN_12)
        Endif
...
oPrn:Say( nLinha            , 650 ,"DESCRIPTION",aFontes:TIMES_NEW_ROMAN_12 ) //"DESCRIPTION" TDF - 27/08/10
oPrn:Say( nLinha            , 1420,"UNIT PRICE "+SW2->W2_MOEDA,aFontes:TIMES_NEW_ROMAN_12 ) //"UNIT US$ " TDF - 27/08/10 //ASR 27/01/2006 - oPrn:Say( nLinha, 480,STR0006+SW2->W2_MOEDA,aFontes:TIMES_NEW_ROMAN_12 )
