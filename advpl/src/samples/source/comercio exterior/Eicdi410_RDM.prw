...
Local aRotina  := { { STR0001   ,'AxPesqui'   , 0 , 1},; //"Pesquisar"
                    ...
                    { STR0003   ,'Eval(bEsto)', 0 , 2},;
                    { "Pequisar Container", 'DI410PesqCont()',0,1}}  //"Estorno Cont's"    
...
Begin sequence
     ...
     DEFINE MSDIALOG oDlgCont FROM 20,30 TO 26,80  TITLE cTit OF oMAINWND 
     ...
     DEFINE MSDIALOG oDlgChave FROM 20,30 TO 26,75 TITLE cTit OF oMAINWND
