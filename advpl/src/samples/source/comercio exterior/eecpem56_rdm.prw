...
Begin Sequence
   ...
   IF cAcao == "NEW"
      ...
      EE4->(dbSetOrder(2))
      EE4->(dbSeek(xFilial()+IncSpace(GetMv("MV_AVG0035",,"PORT. "), 6, .F.)+"-PORTUGUES"))
      DO While !EE4->(Eof()) .And. EE4->EE4_FILIAL == xFilial("EE4") .And. EE4->EE4_IDIOMA = IncSpace(GetMv("MV_AVG0035",,"PORT. "), 6, .F.)+"-PORTUGUES    "
