...
Private cNomDbfD := "REL21D",;
        aCamposD := {{"SEQREL"     ,"C", 8,0},;
                     ...
                     {"EEQ_VL"     ,"C",AvSx3("EEQ_VL"    ,AV_TAMANHO)+5,0 },;                    
                     {"EEQ_TX"     ,"C",AvSx3("EEQ_TX"    ,AV_TAMANHO)+2,0 },;                                         
                     {"EEQ_EQVL"   ,"C",AvSx3("EEQ_EQVL"  ,AV_TAMANHO)+5,0 },;                    
...
Begin Sequence
     ...
     DEFINE MSDIALOG oDlg TITLE cTitRpt FROM 9,0 TO 29,46 OF oMainWnd  //BHF-20/05/09   
   
      @ 14,3 to 146,146 PIXEL //BHF-20/05/09
