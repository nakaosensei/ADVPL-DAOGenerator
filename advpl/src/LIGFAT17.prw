...
/*
DESCRIÇÃO: FUNÇÃO PRA IMPRIMIR AS OS RECIBOS NF DA TELECOMUNIÇÕES
AUTOR:     ROBSON ADRIANO by LIGFAT05
DATA:      08/06/2015
CLIENTE:   LIGUE TELECOM
*/

User Function LIGFAT17(_filial,_doc,_serie,_cliente,_loja,_cPath,_lView)
Local _area 		:= getarea()
...
//PRIMEIRAMENTE VAI IMPRIMIR OS CABEÇALHOS
	...
	oPrint:say(135,700,"LIGUE TELECOMUNICAÇÕES LTDA",oFont11b)
	oPrint:say(170,700,"RUA MATO GROSSO, 1780",oFont10)
	oPrint:say(200,700,"CEP 87300-400 CAMPO MOURÃO/PR - BRASIL",oFont10)
	oPrint:say(230,700,"CNPJ: 10.442.435/0001-40      I.E: 9046098894",oFont10)
	oPrint:say(260,700,"TEL + 55 44 3810-0000",oFont10)
	
	oPrint:say(300,600,"ATENDIMENTO AO CLIENTE: (44) 3810-0000",oFont14b)
	
	oPrint:say(135,1700,"RECIBO NUMERÁRIO",oFont14b)
