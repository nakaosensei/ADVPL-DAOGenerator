...
/*
LIGTEC10 - ALOCAÇÃO DE TÉCNICOS E ASSUNTO NA ORDEM DE SERVIÇO
...
Private cCombo
	...
	IF AB2->AB2_CLASSI == "005"
		...
		cCombo := "6"
	ELSE
		cCombo := "0" //- Variavel que receberá o conteúdo
		...
		DEFINE MSDIALOG oDlg TITLE "INFOMAR TÉCNICO / ASSUNTO " FROM 000, 000  TO 190, 400 COLORS 0, 16777215 PIXEL
				@ 010, 002 SAY oSay1 PROMPT "Técnico: " SIZE 028, 007 OF oDlg COLORS 0, 16777215 PIXEL
